...
$System_Config['appName'] = 'zhandianmingcheng';             //站点名称
$System_Config['baseUrl'] = 'zhandiandizhi';            // 站点地址
$System_Config['muKey'] = 'jiaoyankey';   //用于校验ss-go mu的请求，可以随意修改，但请保持前后端一致
$System_Config['db_driver'] = 'mysql';		//数据库程序
$System_Config['db_host'] = '127.0.0.1'; //数据库地址
$System_Config['db_database'] = 'sspanel';			//数据库名
$System_Config['db_username'] = 'dbuser';		//数据库用户名
$System_Config['db_password'] = 'dbpassword';			//用户名对应的密码

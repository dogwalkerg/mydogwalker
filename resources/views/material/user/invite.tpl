							...
							<div class="card-main">
								<div class="card-inner">
									<div class="card-inner">
										...
										<p>邀请链接请发给需要的人，或发送至<a href="https://plus.google.com/" target="_blank" >Google Plus</a>和贴吧，如：酸酸乳、telegram、netflix吧中。</p>
                                      	<p>请勿发送邀请链接至其他加速器TG或QQ用户群中，如接到投诉立即清空推广佣金并封锁帐号！</p>

				...
				<ul class="nav">
					<li>
						...
						<ul class="menu-collapse collapse in" id="ui_menu_me">
							...
							<li>
								<a href="/user/profile">
									<i class="icon icon-lg">account_balance_wallet</i>&nbsp;账户信息
								</a>
							</li>
							-->
							<li>
								...
								<a href="/user/invite">
                                  ...
                                  -->
									<i class="icon icon-lg">loyalty</i>&nbsp;邀请赚钱
								</a>
							</li>
                          	<!--迷改
							<li>
								<a href="/user/code">
									<i class="icon icon-lg">code</i>&nbsp;捐赠与充值
								</a>
							</li>
							-->
                          	<li>
								<a href="/user/shop">
									<i class="icon icon-lg">shop</i>&nbsp;充值购买
								</a>
							</li>
						...
						<ul class="menu-collapse collapse in" id="ui_menu_use">
							...
							<li>
								<a href="/user/node">
									<i class="icon icon-lg">airplanemode_active</i>&nbsp;查看节点
								</a>
							</li>
							...
							<li>
								<a href="/user/lookingglass">
									<i class="icon icon-lg">visibility</i>&nbsp;延迟测速
								</a>

				...
				<div class="ui-card-wrap">
							...
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										...
										<nav class="tab-nav margin-top-no" style="display:none;">
											...
											<div class="tab-content">
												<div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
													...
													<nav class="tab-nav margin-top-no">
														<ul class="nav nav-list">
															<li class="active">
																<a class="waves-attach1" data-toggle="tab" href="#all_ssr_windows" style="text-transform:none;"><i class="icon icon-lg">desktop_windows</i>&nbsp;Windows</a>
															</li>
															<li>
																<a class="waves-attach" data-toggle="tab" href="#all_ssr_mac"><i class="icon icon-lg">laptop_mac</i>&nbsp;苹果电脑</a>
															</li>
                                                          	
															<li>
																<a class="waves-attach" data-toggle="tab" href="#all_ssr_ios"><i class="icon icon-lg">phone_iphone</i>&nbsp;苹果手机</a>
															</li>
															<li>
																<a class="waves-attach" data-toggle="tab" href="#all_ssr_android"><i class="icon icon-lg">android</i>&nbsp;安卓手机</a>
															</li>
                                                          	<li>
																<a class="waves-attach" data-toggle="tab" href="#all_ssr_game"><i class="icon icon-lg">videogame_asset</i>&nbsp;游戏加速</a>
															</li>
															<li>
						...
						<div class="col-lg-6 col-md-6">
							...
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										<p class="card-heading"><i class="icon icon-md">account_circle</i>账号信息(UID:{$user->id})</p>
										<dl class="dl-horizontal">
											<p><dt>登陆帐号</dt>                                             
                                              <dd><i class="icon icon-md t4-text">account_circle</i>&nbsp;{$user->email}</dd>
                                          </p>
											<p><dt>帐号等级</dt>
                                              {if $user->class!=0}
									...
									<div class="card-action">
										<div class="card-action-btn pull-left">
											{if $user->isAbleToCheckin() }
												<p id="checkin-btn">
													<button id="checkin" class="btn btn-brand btn-flat waves-attach" style="border:1px solid #0f0f0f;"><span class="icon">check</span>&nbsp;点我签到 免费领取512M~1024M流量</button>
											{else}

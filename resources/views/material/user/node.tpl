...
<script src="/assets/mi_js/canvasjs.js"></script>
<script src="/assets/mi_js/jquery.min.js"></script>
...
<style>
  .text-overflow i{
						...
						<div class="col-lg-12 col-sm-12">
							<div class="card">
								...
								<p class="card-heading">免费节点</p> 
                                          <div class="" style="background: linear-gradient(60deg, #23d160, #4594f0);
    display: block;
    font-size: 20px;
    line-height: 28px;
    margin-top: 24px;
    ...
    padding: 10px;
    color: #FFFFFF;
    background-color: #23bcbc;">●测试</div>
											{$id=0}
